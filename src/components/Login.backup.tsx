      ...
      {isLoginModalOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-0 bottom-0 h-[95vh] w-full bg-white dark:bg-slate-800 rounded-t-3xl px-5 py-14 flex flex-col z-50"
            key="loginForm"
          >
            ...
            {isOnPublicPage && (
              <button
                ...
                className="absolute top-6 right-6 w-8 h-8 rounded-full bg-gray-100 dark:bg-slate-700 hover:bg-gray-200 dark:hover:bg-slate-600 flex items-center justify-center transition-colors z-10"
              >
            ...
            <div className="relative w-9/12 flex flex-1 bg-[#dfe0e2] mx-auto rounded-3xl">
              <div className="w-full flex-1 grid grid-cols-2">
                ...
                <div className="flex-1 h-full p-5">
                  <div className="relative flex flex-col flex-1 h-full w-full rounded-3xl bg-white dark:bg-slate-800 items-center justify-center gap-10">
                    ...
                    >
                      <div className="w-7/12 mx-auto text-center flex flex-col items-center justify-center gap-2.5">
                        <h2 className="text-4xl text-gray-800 dark:text-white font-sagace font-medium">
                          Bem-vindo!
                        </h2>
                        <p className="text-gray-600 dark:text-slate-300">
                          Coloque seu e-mail e senha para acessar a conta
                        </p>

                        {/* Indicador visual para páginas privadas */}
                        {!isOnPublicPage && (
                          <p className="text-sm text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/30 px-3 py-1 rounded-full border border-amber-200 dark:border-amber-700">
                      ...
                      <div className="relative flex flex-col gap-5 w-7/12 mx-auto">
                        ...
                        <div className="absolute -bottom-10 w-full flex items-center justify-between">
                          ...
                          <span className="font-medium text-neutral-400 dark:text-slate-400 text-sm">
                            Esqueci a senha
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="absolute bottom-14 text-center text-neutral-700 dark:text-slate-300">
                      <p>
                        Não tem uma conta?{" "}
